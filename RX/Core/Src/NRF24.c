...
void csn_high(void){
	HAL_GPIO_WritePin(SPI_CSN_GPIO_Port, SPI_CSN_Pin, 1);
}

void csn_low(void){
	HAL_GPIO_WritePin(SPI_CSN_GPIO_Port, SPI_CSN_Pin, 0);
}

void ce_high(void){
	HAL_GPIO_WritePin(SPI_CE_GPIO_Port, SPI_CE_Pin, 1);
}

void ce_low(void){
	HAL_GPIO_WritePin(SPI_CE_GPIO_Port, SPI_CE_Pin, 0);
}
